...
abstract class BaseController
{
	...
	protected $inputMethod; // в этом свойстве хранится метод, который подключается и собирает данные из БД
	protected $outputMethod; //в этом свойстве хранится имя метода подключения видов
